"""
Make some (useless) measurements to take some time (for testing
...
max_params = range(2, 3)
samples = np.array([1000])
...
for j, ansatz_name in itertools.product(range(1, 2), ansatz_types):
